...
export interface ManualTransactionCreated { id: string; transactionDate: string; description: string; note: string | null; accountLabel: string | null; externalReference: string | null; direction: Direction; amount: number; currency: string; categoryId: string | null; receiptUrl: string | null }
export interface TransactionWrite { transactionDate: string; description: string; note?: string | null; direction: Direction; amount: number; accountLabel?: string | null; externalReference?: string | null; categoryId?: string | null; receiptUrl?: string | null }
