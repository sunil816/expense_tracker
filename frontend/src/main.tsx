...
import { App, DashboardPage, DuplicateReviewPage, ReviewPage, TransactionsPage, ManualTransactionPage, EditTransactionPage, TransactionDetailPage, UploadPage } from './App'
import './styles/global.css'

const router = createBrowserRouter([{ path: '/', element: <App />, children: [
  { index: true, element: <DashboardPage /> }, { path: 'transactions', element: <TransactionsPage /> }, { path: 'review', element: <ReviewPage /> }, { path: 'duplicates', element: <DuplicateReviewPage /> },
